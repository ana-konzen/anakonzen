...
<ProjectSection images={[{url: "/replica/1.webp", caption: "Current Replica packaging"}]} vertical>
...
<ProjectSection images={[{url: "/replica/2.png", caption: "Digital labels"}]}>
