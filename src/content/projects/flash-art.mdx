export const data = {
  ...
  heroStyling:
    "appearance-none md:-bottom-80 md:-top-60 md:w-auto select-none md:h-[1200px] left-0 object-bottom-left object-cover top-16 overflow-visible absolute h-svh w-screen",
